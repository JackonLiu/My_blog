...
<head>
    ...
    <link rel="icon" sizes="192x192" href="${path}/image/assets/app-icon72x72@2x.png">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="Amaze UI"/>
    <link rel="apple-touch-icon-precomposed" href="${path}/image/assets/app-icon72x72@2x.png">
    <meta name="msapplication-TileImage" content="${path}/image/assets/app-icon72x72@2x.png">
...
<nav class="am-g am-g-fixed blog-fixed blog-nav">
    ...
    <div class="am-collapse am-topbar-collapse" id="blog-collapse">
        <ul class="am-nav am-nav-pills am-topbar-nav">
            <li class="am-active"><a href="${path}/index">首页</a></li>
            <li><a href="${path}/article-">博文</a></li>
            <li class="am-dropdown" data-am-dropdown>
                <a class="am-dropdown-toggle" data-am-dropdown-toggle href="javascript:;">
                    首页布局 <span class="am-icon-caret-down"></span>
                </a>
                <ul class="am-dropdown-content">
                    <li><a href="javascript:;">1. blog-index-standard</a></li>
                    <li><a href="javascript:;">2. blog-index-nosidebar</a></li>
                    <li><a href="javascript:;">3. blog-index-layout</a></li>
                    <li><a href="javascript:;">4. blog-index-noslider</a></li>
                </ul>
            </li>
            <li><a href="${path}/img">图片库</a></li>
        </ul>
...
<div class="am-g am-g-fixed blog-fixed am-u-sm-centered blog-article-margin">
    <div data-am-widget="slider" class="am-slider am-slider-b1" data-am-slider='{&quot;controlNav&quot;:false}' >
        <ul class="am-slides">
            <li>
                <img src="${path}/image/assets/b1.jpg">
            ...
            <li>
                <img src="${path}/image/assets/b2.jpg">
            ...
            <li>
                <img src="${path}/image/assets/b3.jpg">
                <div class="am-slider-desc blog-slider-desc">
                    <div class="blog-text-center blog-slider-con">
                        <span><a href="" class="blog-color">Article &nbsp;</a></span>
                        <h1 class="blog-h-margin"><a href="">总在思考一句积极的话</a></h1>
...
<div class="am-g am-g-fixed blog-fixed">
    <div class="am-u-md-8 am-u-sm-12">
        <div data-am-widget="tabs" class="am-tabs am-tabs-default">
            ...
            <ul class="am-tabs-nav am-nav am-nav-tabs">
                ...
                <li><a href="#1">分类1</a></li>
                <li><a href="#2">分类2</a></li>
                <li><a href="#3">分类3</a></li>
                <li><a href="#4">分类4</a></li>
            </ul>
            <!-- tab end -->
            <div class="am-tabs-bd">
                <div class="am-tab-panel am-fade am-in am-active" id="all">
                    <article class="am-g blog-entry-article">
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img">
                            <img src="${path}/image/assets/f10.jpg" alt="" class="am-u-sm-12">
                        </div>
                    ...
                    <article class="am-g blog-entry-article">
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img">
                            <img src="${path}/image/assets/f6.jpg" alt="" class="am-u-sm-12">
                        </div>
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-text">
                            <span><a href="" class="blog-color">article&nbsp;</a></span>
                            <span>@amazeUI &nbsp;</span>
                    ...
                    <article class="am-g blog-entry-article">
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img">
                            <img src="${path}/image/assets/f12.jpg" alt="" class="am-u-sm-12">
                        </div>
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-text">
                            <span><a href="" class="blog-color">article&nbsp;</a></span>
                            <span>@amazeUI</span>
                    ...
                    <article class="am-g blog-entry-article">
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img">
                            <img src="${path}/image/assets/f22.jpg" alt="" class="am-u-sm-12">
                        </div>
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-text">
                            <span><a href="" class="blog-color">article&nbsp;</a></span>
                            <span>@amazeUI</span>
                    ...
                    <article class="am-g blog-entry-article">
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img">
                            <img src="${path}/image/assets/f18.jpg" alt="" class="am-u-sm-12">
                        </div>
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-text">
                            <span><a href="" class="blog-color">article&nbsp;</a></span>
                            <span> @amazeUI &nbsp;</span>
                    ...
                    <article class="am-g blog-entry-article">
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img">
                            <img src="${path}/image/assets/f20.jpg" alt="" class="am-u-sm-12">
                        </div>
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-text">
                            <span><a href="" class="blog-color">article&nbsp;</a></span>
                            <span> @amazeUI &nbsp;</span>
                    ...
                    <article class="am-g blog-entry-article">
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img">
                            <img src="${path}/image/assets/f19.jpg" alt="" class="am-u-sm-12">
                        </div>
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-text">
                            <span><a href="" class="blog-color">article&nbsp;</a></span>
                            <span> @amazeUI &nbsp;</span>
                ...
                <div class="am-tab-panel am-fade" id="1">
                    <article class="am-g blog-entry-article">
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img">
                            <img src="${path}/image/assets/f10.jpg" alt="" class="am-u-sm-12">
                        </div>
                ...
                <div class="am-tab-panel am-fade" id="2">
                    <article class="am-g blog-entry-article">
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img">
                            <img src="${path}/image/assets/f10.jpg" alt="" class="am-u-sm-12">
                        </div>
                ...
                <div class="am-tab-panel am-fade" id="3">
                    <article class="am-g blog-entry-article">
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img">
                            <img src="${path}/image/assets/f10.jpg" alt="" class="am-u-sm-12">
                        </div>
                ...
                <div class="am-tab-panel am-fade" id="4">
                    <article class="am-g blog-entry-article">
                        <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img">
                            <img src="${path}/image/assets/f10.jpg" alt="" class="am-u-sm-12">
                        </div>
    ...
    <div class="am-u-md-4 am-u-sm-12 blog-sidebar">
        <div class="blog-sidebar-widget blog-bor">
            ...
            <img src="${path}/image/assets/f14.jpg" alt="about me" class="blog-entry-img" >
            <p>妹纸</p>
            <p>
...
<script src="${path}/js/assets/amazeui.ie8polyfill.min.js"></script>
<![endif]-->
